    ...
    <>
      ...
      <section className="content-section dark2">
        <div className="content-inner">
          ...
          <p>The rare earth market entered 2026 in a state of acute supply stress. China&apos;s Announcement 18 export controls, introduced in April 2025, have reduced the availability of dysprosium, terbium, samarium and yttrium to Western buyers to a fraction of before controls levels. The result is a supply shortage that is affecting EV manufacturers, wind turbine producers, defence contractors and electronics companies across the US, EU, Japan and South Korea.</p>
          ...
          <p><strong>Australia: the most developed source.</strong> Lynas Rare Earths at Mount Weld produces and separates neodymium, praseodymium, lanthanum and cerium at commercial scale. Its heavy rare earth capabilities are growing, with a new facility in Western Australia under development for dysprosium and terbium separation. Lynas is the only commercially significant producer of separated rare earth products outside China and has long term supply agreements with Japanese and US customers.</p>
