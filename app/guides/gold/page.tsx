    ...
    <>
      ...
      <section className="content-section dark2">
        <div className="content-inner">
          ...
          <p>Unlike industrial metals, gold is not primarily consumed in production. Roughly 50% of annual supply goes to jewellery, around 25% to investment (bars, coins, ETFs), 10% to central bank purchases, and only about 10 to 15% to technology and industrial applications. This means gold&apos;s price is driven as much by financial sentiment, currency dynamics, and geopolitical risk as by supply and demand fundamentals.</p>
          ...
          <p>The LBMA also sets the <strong>Good Delivery Standard</strong> , the specifications that gold bars must meet to be accepted for settlement in the London OTC market. Good delivery gold bars must weigh between 350 and 430 fine troy ounces (approximately 10.9 to 13.4 kg), be a minimum 99.5% fineness, and be produced by an accredited refiner on the LBMA Good Delivery List. These bars form the core of the physical gold trading system.</p>
          ...
          <p><strong>Doré</strong>: Unrefined gold produced at the mine , typically 70 to 90% gold with silver and other impurities. Miners sell doré to refineries, which process it to Good Delivery standard. The doré price is typically the spot price minus the refinery&apos;s charges (treatment fee + refining charge).</p>
          ...
          <p>For investors, physical gold and gold ETFs represent different risk and return profiles. <strong>Physical gold</strong> , bars and coins , provides direct ownership of the metal, eliminating counterparty risk. It requires secure storage and insurance but provides ultimate financial security in a crisis.</p>
