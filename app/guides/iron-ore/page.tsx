    ...
    <>
      ...
      <section className="content-section dark2">
        <div className="content-inner">
          ...
          <p><strong>Lump ore</strong> consists of coarser particles, typically 6.3–31.5mm, that can be charged directly into a blast furnace. Lump ore commands a premium — typically $10–$30/t over fines — because it reduces sintering costs at the mill. Australia&apos;s Pilbara mines are the dominant source of high-quality lump ore.</p>
          <p><strong>Pellets</strong> are small, spherical balls of processed iron ore (typically 8–16mm) produced by milling ore fines, mixing with binders, and heat-hardening in a kiln. They offer excellent blast furnace performance but come at a significant cost premium over fines. Pellets are also the preferred feed for Direct Reduction (DR) steelmaking — the dominant process for producing electric arc furnace (EAF) grade steel.</p>
          ...
          <p><strong>South Africa</strong> exports around 70–80 million tonnes per year from operations in the Northern Cape (Kumba Iron Ore / Sishen, Kolomela) and the Eastern Limb.</p>
          ...
          <p>Actual transaction prices are set as a premium or discount to the benchmark, reflecting grade, product form, origin, and market conditions. A 65% Fe lump cargo from the Pilbara might trade at a 30–40% premium to the 62% Fe fines benchmark; a 58% Fe Indian fines cargo might trade at a 20–25% discount.</p>
