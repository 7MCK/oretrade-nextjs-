    ...
    <>
      ...
      <section className="content-section dark2">
        <div className="content-inner">
          ...
          <p>The brine extraction process begins by pumping lithium rich brine from underground aquifers to the surface, where it is channelled into a series of large evaporation ponds. Over a period of 12 to 24 months, solar evaporation concentrates the lithium content from typically 0.15 to 0.20% Li to 6% Li or more, while potassium, magnesium, and other salts are progressively removed.</p>
          ...
          <p>Hard rock lithium mining accounts for approximately 40% of current global lithium production and is growing rapidly, primarily in Australia. The primary lithium rich mineral in hard rock deposits is spodumene , a lithium aluminium pyroxene mineral containing 3 to 7% Li₂O when pure.</p>
