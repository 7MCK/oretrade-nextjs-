    ...
    <>
      ...
      <section className="content-section dark2">
        <div className="content-inner">
          ...
          <p>The brine extraction process begins by pumping lithium-bearing brine from underground aquifers to the surface, where it is channelled into a series of large evaporation ponds. Over a period of 12–24 months, solar evaporation concentrates the lithium content from typically 0.15–0.20% Li to 6% Li or more, while potassium, magnesium, and other salts are progressively removed.</p>
          <p>The concentrated lithium brine is then processed at a chemical plant to remove remaining impurities and convert it into lithium carbonate (Li₂CO₃) or lithium hydroxide (LiOH). Brine extraction is relatively low-cost — production costs of $3,000–5,000 per tonne of LCE (lithium carbonate equivalent) are typical for the best operations — but it is highly water-intensive and subject to permitting challenges.</p>
          <p><strong>Atacama, Chile</strong>: The Atacama salt flat hosts the world&apos;s largest and highest-grade lithium brine deposit. SQM and Albemarle operate here under concession agreements with the Chilean state (CORFO). The Atacama produces roughly 35–40% of global lithium supply.</p>
          ...
          <p>Hard rock lithium mining accounts for approximately 40% of current global lithium production and is growing rapidly, primarily in Australia. The primary lithium-bearing mineral in hard rock deposits is spodumene — a lithium aluminium pyroxene mineral containing 3–7% Li₂O when pure.</p>
          ...
          <p>The hard rock mining process is conventional: drill, blast, crush, and beneficiate. Spodumene ore containing 1.5–2.5% Li is crushed and processed through dense medium separation and flotation to produce spodumene concentrate — typically 5.5–6.0% Li₂O — which is the primary traded product from hard rock operations.</p>
          ...
          <p>Battery demand is in turn driven overwhelmingly by electric vehicles. Global EV sales exceeded 14 million units in 2023 and are projected to reach 45–50 million by 2030. Each EV requires 5–10 kg of lithium carbonate equivalent (LCE) depending on battery chemistry and size. Grid-scale energy storage is an additional and growing demand driver, projected to represent 20–30% of battery demand by 2030.</p>
