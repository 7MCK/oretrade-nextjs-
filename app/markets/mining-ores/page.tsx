    ...
    <>
      ...
      <section className="content-section cream">
        <div className="content-inner">
          ...
          <h3>Bauxite</h3>
          <p>The primary aluminium ore, traded primarily from Guinea (which holds 25% of world reserves), Australia, Jamaica, and Indonesia. Typically contains 40–60% Al₂O₃. Major buyers are alumina refineries in China, which processes over 70% of global seaborne bauxite supply.</p>

          <h3>Chromite</h3>
          <p>The only commercially viable ore of chromium, essential for stainless steel and superalloys. South Africa holds 75% of world chromite reserves. Chromite ore typically contains 42–48% Cr₂O₃ and is traded in bulk to ferrochrome producers globally.</p>

          <h3>Manganese Ore</h3>
          <p>Essential for steel production (used as a deoxidiser and in manganese steel alloys) and increasingly as a battery cathode material (LMF chemistry). Major producers include South Africa, Australia, Gabon, and Ghana. Typically traded in 38–48% Mn grade ranges.</p>
        </div>
      </section>
      ...
      <section className="content-section dark">
        <div className="content-inner">
          ...
          <table className="specs-table">
            ...
            <tbody>
              <tr><td>Iron Ore (Fines)</td><td>57% – 67% Fe</td><td>50,000 – 200,000 DMT</td><td>Australia, Brazil, South Africa</td></tr>
              <tr><td>Bauxite</td><td>40% – 60% Al₂O₃</td><td>30,000 – 100,000 DMT</td><td>Guinea, Australia, Jamaica</td></tr>
              <tr><td>Chromite</td><td>42% – 48% Cr₂O₃</td><td>20,000 – 60,000 DMT</td><td>South Africa, Kazakhstan, India</td></tr>
              <tr><td>Manganese Ore</td><td>38% – 48% Mn</td><td>30,000 – 80,000 DMT</td><td>South Africa, Australia, Gabon</td></tr>
            </tbody>
          </table>
        </div>
      </section>
