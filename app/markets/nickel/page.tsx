    ...
    <>
      ...
      <section className="content-section cream">
        <div className="content-inner">
          ...
          <p>Nickel is at the centre of two major industrial megatrends: stainless steel production (which accounts for roughly 70% of nickel demand) and lithium-ion battery manufacturing for electric vehicles (a rapidly growing share projected to reach 30–40% by 2030). This dual demand profile makes nickel one of the most strategically important metals of the energy transition.</p>
      ...
      <section className="content-section dark">
        <div className="content-inner">
          ...
          <table className="specs-table">
            ...
            <tbody>
              <tr><td>Nickel Ore (laterite)</td><td>1.0% – 2.5% Ni</td><td>NPI / ferronickel feed</td><td>Indonesia, Philippines, New Caledonia</td></tr>
              <tr><td>Nickel Ore (sulphide)</td><td>0.5% – 3.0% Ni</td><td>Concentrate / refinery feed</td><td>Canada, Russia, Australia</td></tr>
              <tr><td>Nickel Pig Iron (NPI)</td><td>4% – 15% Ni</td><td>Stainless steel</td><td>Indonesia, China</td></tr>
              <tr><td>Ferronickel</td><td>15% – 40% Ni</td><td>Stainless steel</td><td>Indonesia, Philippines, New Caledonia</td></tr>
