    ...
    <>
      ...
      <section className="content-section dark">
        <div className="content-inner">
          ...
          <table className="specs-table">
            ...
            <tbody>
              <tr><td>NdPr Oxide Price</td><td style={{ color: '#4ade80' }}>~$144/kg (magnet grade, ex-China)</td></tr>
              ...
              <tr><td>Leading Non-China Producers</td><td>Lynas (AU/MY), MP Materials (US), Energy Fuels (US)</td></tr>
      ...
      <section className="content-section dark2">
        <div className="content-inner">
          ...
          <h3>Non-China NdPr Production</h3>
      ...
      <section className="content-section dark">
        <div className="content-inner">
          ...
          <h3>Who are the main non-China NdPr producers?</h3>
          <p>The primary non-China NdPr producer is Lynas Rare Earths, producing approximately 6,000 tonnes per year at its LAMP facility in Malaysia. MP Materials (California) and Energy Fuels (Utah) are building US separation capacity. Arafura Resources (Australia) and others are in development stages.</p>
