...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Samarium oxide (Sm2O3, 99.9% purity) traded at approximately $4.50/kg as of early 2026 in non-China markets, though premiums for documented ex-China supply are significant following export controls. Samarium was placed under Chinese export licensing controls in Announcement 18 (April 2025), restricting Western supply.',
      },
    },
    {
      '@type': 'Question',
    ...
    <>
      ...
      <section className="content-section dark">
        <div className="content-inner">
          ...
          <table className="specs-table">
            ...
            <tbody>
              <tr><td>Sm2O3 Reference Price</td><td style={{ color: '#4ade80' }}>~$4.50/kg (99.9% purity, ex-China premium applies)</td></tr>
              ...
              <tr><td>Major Non-China Sources</td><td>Australia (Lynas — trace), USA (Energy Fuels), Canada (early stage)</td></tr>
      ...
      <section className="content-section dark">
        <div className="content-inner">
          ...
          <p>Samarium oxide (Sm2O3, 99.9% purity) traded at approximately $4.50/kg as of early 2026 in non-China markets. Ex-China premiums are significant following Announcement 18 export controls. Samarium was placed under Chinese export licensing controls in April 2025, restricting Western supply access.</p>
