...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yttrium oxide (Y2O3, 99.9% purity) traded at approximately $3.80/kg as of early 2026 in reference markets. However, ex-China premiums are rising following Announcement 18 export controls introduced in April 2025. Yttrium is classified as a critical material by the EU Critical Raw Materials Act and the US government.',
      },
    },
    {
      '@type': 'Question',
    ...
    <>
      ...
      <section className="content-section dark">
        <div className="content-inner">
          ...
          <table className="specs-table">
            ...
            <tbody>
              <tr><td>Y2O3 Reference Price</td><td style={{ color: '#4ade80' }}>~$3.80/kg (99.9% purity, ex-China premium applies)</td></tr>
      ...
      <section className="content-section dark">
        <div className="content-inner">
          ...
          <p>Yttrium oxide (Y2O3, 99.9% purity) traded at approximately $3.80/kg as of early 2026 in reference markets. Ex-China premiums are rising following Announcement 18 export controls introduced in April 2025. Yttrium is classified as a critical material by both the EU Critical Raw Materials Act and the US government.</p>
